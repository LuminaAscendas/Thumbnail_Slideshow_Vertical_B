...
setTimeout(function(){
	//$('.swiper-slide-active img')[0].focus();
},200);
    if (runCallbacks && activeIndex !== previousIndex) {
	  ...
	  //console.log(activeIndex)
		...
		//$('#dummy_reader,#reverse_extra_tab').attr('aria-hidden','true');
			//$('#direction_text').removeAttr('role').focus();
		}else{
			//alert();
			//$('#head_ing').addClass('tab_index').attr('tabindex','0');
  ...
  var A11y = {
    ...
    params: {
      a11y: {
        ...
        paginationBulletMessage_1: 'Go to slide {{index}}',
		//id:'bullet_{{index}}'  
      },
    },
    create: function create() {
